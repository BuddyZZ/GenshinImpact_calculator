...
int logger::logAttribute(tAllAttr *obj, int type)
{
}

int logger::logAttributeFix(tAllAttr *obj, int type)
{
    // cout << attributeFixLog[type] << (*((float *)&(obj->attrF) + type)) << endl;
}

int logger::logRes(tAllAttr *obj, int damageType, int elementType)
{
    float resValue = 0;
    switch (damageType)
    {
...
int logger::logBonus(tAllAttr *obj, int type)
{
}

int logger::logIndepMult(tAllAttr *obj, int type)
{
}

int logger::logExtraRate(tAllAttr *obj, int type)
{
}

int logger::logReactFactor(tAllAttr *obj, int type)
{
}

int logger::logBuff(tAllAttr *obj, int type)
{
}
...
// };
int logger::logInfo(tAllAttr *obj, int type)
{
    if (obj == NULL)
    {
        return 0;
...
int logger::logAttack(tAllAttr *obj, int type)
{
}

int logger::logBurst(tAllAttr *obj, int type)
{
}

int logger::logSkill(tAllAttr *obj, int type)
{
}
